...
export default function sitemap(): MetadataRoute.Sitemap {
  const baseUrl = 'https://www.dayofus.org'
  ...
  return [
    ...
    { url: `${baseUrl}/venue`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${baseUrl}/guides/wedding-budget-breakdown`, lastModified: new Date(), changeFrequency: 'yearly', priority: 0.7 },
    { url: `${baseUrl}/guides/wedding-guest-list-size`, lastModified: new Date(), changeFrequency: 'yearly', priority: 0.7 },
